...
void MetaCluster::ComputeRank(int centerid)
{
	...
	centerRank[centerid] = toSpear(centerDistri[centerid],ReverSize);
}
...
int MetaCluster::iterMeta(const int ROUND,double threshold)
{
	...
	cerr<<" final: before and after 2: "<<classes<<",\t"<<lastsize<<endl;
	///////////////////////////////////////////
	///////////////////////////////////////////
	return lastsize;
}
